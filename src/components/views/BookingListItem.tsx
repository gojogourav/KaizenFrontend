...
export const BookingListItem: React.FC<{ booking: Booking }> = ({
  ...
  return (
    <motion.article
      ...
      className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 hover:border-white/20 p-6 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6"
    >
      <div className="space-y-1">
        <div className="flex items-center gap-3">
          <span className="text-xs font-bold font-mono text-[#FF8A73] bg-white/10 px-3 py-1 rounded-full border border-white/15">
            #{id}
          </span>
