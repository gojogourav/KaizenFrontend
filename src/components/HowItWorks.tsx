...
export const HowItWorks: React.FC<{ onBrowseProperties: () => void }> = ({ onBrowseProperties }) => {
  ...
  return (
    <div className="space-y-12 animate-fade-in font-sans text-slate-100 max-w-6xl mx-auto">
      
      {/* Header Banner */}
      <div className="glass-card bg-gradient-to-r from-[#16062b] via-[#20093e] to-[#110522] rounded-3xl p-8 sm:p-10 border border-purple-500/30 shadow-2xl relative overflow-hidden">
        <div className="relative z-10 space-y-4 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-purple-950/80 rounded-full border border-purple-500/40">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white font-serif tracking-tight leading-tight">
            How Kaizen Works for <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Turnkey Buyers</span>
          </h1>
          ...
          <div className="pt-2 flex flex-wrap items-center gap-4">
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all shadow-lg shadow-purple-600/30 flex items-center gap-2 font-mono cursor-pointer"
            >
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <span className="text-xs font-mono font-bold uppercase tracking-widest text-purple-400">Step-by-Step Guide</span>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-white font-serif">4 Steps to Lock & Own Your Turnkey Property</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {STEPS.map((step) => {
            ...
            return (
              <div 
                key={step.num}
                className="glass-card p-8 rounded-3xl border border-purple-900/40 hover:border-purple-500/40 transition-all duration-300 space-y-4 relative group"
              >
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-3xl font-black text-purple-900/60 font-mono group-hover:text-purple-500/40 transition-colors">
                    {step.num}
                  </span>
                </div>

                <div>
                  <span className="inline-block px-2.5 py-0.5 rounded-full bg-purple-950 text-purple-300 text-[10px] font-mono font-bold mb-2 border border-purple-800/40">
                    {step.badge}
                  </span>
                  <h3 className="text-lg font-extrabold text-white font-serif">{step.title}</h3>
      ...
      <div className="glass-card rounded-3xl border border-purple-500/30 p-8 sm:p-10 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        
        <div className="lg:col-span-5 space-y-4">
          <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-purple-400 bg-purple-950/80 px-3 py-1 rounded-full border border-purple-500/30">
        ...
        <div className="lg:col-span-7 bg-[#0B0A14] p-6 sm:p-8 rounded-2xl border border-purple-900/50 shadow-xl">
          {formSubmitted ? (
            <div className="p-8 text-center space-y-4 animate-scale-in">
              ...
              <h4 className="text-lg font-bold text-white font-serif">Inquiry Received</h4>
              ...
              <button
                ...
                className="mt-4 px-4 py-2 bg-purple-950 hover:bg-purple-900 text-purple-300 rounded-xl text-xs font-mono font-bold border border-purple-700/50"
              >
            ...
            <form onSubmit={handleSubmitInquiry} className="space-y-4 text-xs font-sans">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase mb-1 font-mono">Your Name *</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full px-3.5 py-2.5 bg-[#141226] border border-purple-900/50 rounded-xl text-white text-xs focus:outline-none focus:border-purple-500"
                  />
                </div>

                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase mb-1 font-mono">Email Address *</label>
                  <input
                    type="email"
                    required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase mb-1 font-mono">Primary Goal / Intent *</label>
                  <select
                    value={inquiryForm.intent}
                    onChange={(e) => setInquiryForm({ ...inquiryForm, intent: e.target.value })}
                    className="w-full px-3.5 py-2.5 bg-[#141226] border border-purple-900/50 rounded-xl text-white text-xs focus:outline-none focus:border-purple-500 font-mono"
                  >
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-400 uppercase mb-1 font-mono">Preferred Market</label>
                  <select
              ...
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-1 font-mono">Message / Specific Questions</label>
                <textarea
                  rows={3}
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all shadow-lg shadow-purple-600/30 flex items-center justify-center gap-2 font-mono cursor-pointer"
              >
