...
export const PlatformSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6 text-slate-100 font-sans max-w-4xl">
      ...
      {/* Header Bar */}
      <div className="pb-4 border-b border-purple-900/60">
        <h2 className="text-2xl font-black text-white flex items-center gap-2">
          <Settings className="w-6 h-6 text-fuchsia-400" />
          Global Platform <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-indigo-400">Settings & Config</span>
        </h2>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-[#18082e] rounded-3xl border border-purple-800/60 p-6 shadow-xl space-y-4">
          <h3 className="text-sm font-extrabold text-white uppercase tracking-wider font-mono flex items-center gap-2 text-fuchsia-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[#120524] border border-purple-900/80 rounded-xl text-slate-100 font-mono focus:outline-none focus:border-fuchsia-500"
              />
        ...
        <div className="bg-[#18082e] rounded-3xl border border-purple-800/60 p-6 shadow-xl space-y-4">
          <h3 className="text-sm font-extrabold text-white uppercase tracking-wider font-mono flex items-center gap-2 text-pink-300">
            <ShieldCheck className="w-4 h-4" />
            Security & Lease Approval Rules
          </h3>

          <div className="space-y-3 text-xs">
            <div className="flex items-center justify-between p-3 bg-[#120524] rounded-2xl border border-purple-900/60">
              <div>
        ...
        <div className="bg-[#18082e] rounded-3xl border border-purple-800/60 p-6 shadow-xl space-y-4">
          <h3 className="text-sm font-extrabold text-white uppercase tracking-wider font-mono flex items-center gap-2 text-indigo-300">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[#120524] border border-purple-900/80 rounded-xl text-slate-100 focus:outline-none focus:border-fuchsia-500"
              />
            </div>
          </div>
        </div>
        ...
        <div className="pt-2 flex justify-end">
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-3 bg-gradient-to-r from-fuchsia-600 via-pink-600 to-rose-600 text-white rounded-xl text-xs font-bold shadow-lg shadow-pink-600/30 hover:opacity-90 transition-all flex items-center gap-2 cursor-pointer font-sans"
          >
